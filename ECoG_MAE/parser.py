...
def arg_parser():
    ...
    # General config
    parser.add_argument(
        "--config-file", type=str, default="configs/video_mae_train.ini"
    )
    parser.add_argument(
        "--job-name",
        type=str,
        help="Name of training job. Will be used to save metrics.",
    )
    parser.add_argument("--debug", dest="debug", action="store_true")
    parser.set_defaults(debug=False)

    # ViTConfig parameters
    parser.add_argument("--dim", type=int, help="Dimensionality of token embeddings.")
    parser.add_argument(
        "--decoder-embed-dim",
        type=int,
    ...
    parser.add_argument("--depth", type=int, help="Depth of encoder.")
    parser.add_argument("--decoder-depth", type=int, help="Depth of decoder.")
    parser.add_argument("--num-heads", type=int, help="Number of heads in encoder.")
    parser.add_argument(
        "--decoder-num-heads", type=int, help="Number of heads in decoder."
    )
    parser.add_argument(
        "--patch-size", type=int, help="The number of electrodes in a patch."
    )
    parser.add_argument(
        "--frame-patch-size",
        type=int,
    ...
    parser.add_argument("--batch-size", type=int, help="Batch size to train with.")
    parser.add_argument(
        "--env",
        dest="env",
        action="store_true",
    ...
    parser.add_argument(
        "--bands", type=str, help="Frequency bands for filtering raw iEEG data."
    )
    parser.add_argument(
        "--original-fs", type=int, help="Original sampling frequency of data."
    )
    parser.add_argument("--new-fs", type=int, help="Frequency to resample data to.")
    parser.add_argument(
        "--dataset-path", type=str, help="Relative path to the dataset root directory."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--max-learning-rate", type=float, help="Max learning rate for scheduler."
    )
    parser.add_argument(
        "--num-epochs", type=int, help="Number of epochs to train over data."
    )
    parser.add_argument("--loss", type=str, help="Type of loss to use.")
    ...
    parser.add_argument("--plot-dir", type=str, help="Directory to save plots to.")
    parser.add_argument(
        "--print-freq",
        type=int,
